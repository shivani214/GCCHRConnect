                        ...
                        <Columns>
                                ...
                                <ItemTemplate>
                                    ...
                                    <div>
                                        <asp:Repeater ID="Repeater1" runat="server" DataSource='<%# Eval("Tags") %>'>
                                            <ItemTemplate>
                                                <asp:Label Text='<%# Container.DataItem %>' CssClass='<%# GetTagStyle(Container.ItemIndex) %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </div>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Repeater DataSource='<%# Eval("Addresses") %>' runat="server">
                                        <ItemTemplate>
                                            <asp:Button Text='<%# Eval("City") %>' CssClass="btn btn-default" runat="server" data-toggle="tooltip" data-placement="bottom" title='<%# Container.DataItem.ToString() %>' data-original-title="Tooltip on bottom" />
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ItemTemplate>
                            </asp:TemplateField>
